...
<html lang = "eng">
	<head>
		<title>Caraga State University Student Attendance Record System</title>
		<?php include('header.php') ?>
	</head>
	<body>
		<?php include '..\attendance\admin\nav_bar_home.php' ?>
							...
							<div class="col-md-12">
									...
									<form action="" id="att-log-frm" >
										<div class="form-group">
											<label style="font-family:Poppins;font-size:20;">STUDENT ID:</label>
										...
										<div class="text-center" id="log_display" style="margin-top:10px;"></div>
		...
		$(document).ready(function(){
			...
			$('.log_now').each(function(){
				$(this).click(function(){
					...
					if(eno == ''){
						alert("Please Enter the Student ID Number!");
					}else{
						$('.log_now').hide()		
						$('.loading').show()
						$.ajax({
