...
<html lang = "eng">
	<head>
		<title>Student Attendance List | Caraga State University Student Attendance Record System</title>
		...
		<div class = "container-fluid admin" >
			...
			<div class = "well col-lg-12">
				<table id="table" class="table table-bordered table-striped">
					...
					<tbody>
					<?php
						$attendance_qry = $conn->query("SELECT a.*,concat(e.firstname,' ',e.middlename,' ',e.lastname) as name,(e.department) as partment,(e.position) as courseyr, e.employee_no FROM `attendance` a inner join employee e on a.employee_id = e.id ") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							<td><?php echo htmlentities($row['partment'])?></td>
							<td><?php echo htmlentities($row['courseyr'])?></td>
