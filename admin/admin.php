...
<html lang="eng">
	<head>
		<title>Administrator Users List| Caraga State University Student Attendance Record System</title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="container-fluid admin" >
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content ">
						<div class="modal-body">
							<center><label class="text-danger">Delete this Person?</label></center>
							<br />
			...
			<div class="well col-lg-12">
				<button type="button" class="btn btn-primary btn-sm" id="new_user"><i class="fa fa-plus"></i> Add New Administrator</button>
				<br />
				<br />
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.remove_user').click(function(){
				...
				var _conf = confirm("Are you sure to delete this User ?");
				if(_conf == true){
					$.ajax({
				...
				$.ajax({
					...
					success:function(resp){
						if(typeof resp !=undefined){
							...
							$('#manage_user .modal-title').html('Edit Admin')
			...
			$('#new_user').click(function(){
				...
				$('[name="lastname"]').val('')
				$('[name="username"]').val('')
				$('#manage_user .modal-title').html('Add New Admin')
				$('#manage_user').modal('show')
			})
		});
	</script>
